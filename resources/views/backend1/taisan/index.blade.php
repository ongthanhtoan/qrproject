	...
	<tbody>
		...
		<tr >
			...
			<td class="text-center font-size-10">
				...
				<span class="badge badge-pill m-2 badge-success">X</span>
				@else
				<span class="badge badge-pill m-2 badge-danger"></span>
				@endif
			</td>
			<td class="text-center font-size-10">
			...
			<td class="text-center">
				...
				<!-- <button data-id="{{$taisan->ts_MaTS}}" type="button" class="btn btn-red btn-icon btnXoa">
